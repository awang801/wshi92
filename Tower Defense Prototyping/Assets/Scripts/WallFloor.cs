...
public class WallFloor : MonoBehaviour {
	...
	Animator[] animator;
	int opencloseHashLeft;
	int opencloseHashRight;
	...
	void Awake () {
		...
		opencloseHashLeft = Animator.StringToHash ("OpenOrCloseLeft");
		opencloseHashRight = Animator.StringToHash ("OpenOrCloseRight");
		animator[0].SetInteger(opencloseHashLeft, openOrClose);
		animator[1].SetInteger(opencloseHashRight, openOrClose);
	}
